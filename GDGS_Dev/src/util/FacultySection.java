...
public class FacultySection implements ActionListener {
    ...
    class BackgroundPanel extends JPanel {
        ...
        public BackgroundPanel() {
            try {
                backgroundImage = new ImageIcon("D:\\Git Hub\\JAVA-PROJECT-4.0\\GDGS_Dev\\src\\util\\GDS SYSTEM(3).png").getImage();
            } catch (Exception e) {
...
public void actionPerformed(ActionEvent e) {
    if (e.getSource() == loginButton) {
        ...
        if (validateAdminLogin(email, password)) {
            ...
            new infacultysection(email);  // Open the Hello World page
        } else {
