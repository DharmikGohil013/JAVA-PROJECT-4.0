...
public class facultyGradingSystemInfo {

    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new facultyGradingSystemInfo().createAndShowGUI());
    }

    private void createAndShowGUI() {
        JFrame frame = new JFrame("faculty GradingSystem Information");
